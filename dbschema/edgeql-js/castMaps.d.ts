...
export declare type scalarAssignableBy<T extends $.ScalarType> = T extends _std.$number
	? _std.$number
								...
								: T extends _std.$int16
									...
									: T extends _std.$float64
										...
										: T extends _std.$float32
											? _std.$float32
											: T extends _stdenc.$Base64Alphabet
												? _stdenc.$Base64Alphabet
...
export declare type scalarCastableFrom<T extends $.ScalarType> = T extends _std.$number
	? _std.$number
	: T extends _sys.$VersionStage
		? _sys.$VersionStage
		: T extends _sys.$TransactionIsolation
...
declare type getSharedParentScalar<A, B> = A extends _std.$number
...
export declare type scalarWithConstType<T extends $.ScalarType, TsConstType> = $.ScalarType<
	T['__name__'],
	T['__tstype__'],
	T['__tsargtype__'],
	TsConstType
>;
export declare type literalToScalarType<T extends any> = T extends number
...
declare type literalToTypeSet<T extends any> = T extends $.TypeSet ? T : $.$expr_Literal<literalToScalarType<T>>;
