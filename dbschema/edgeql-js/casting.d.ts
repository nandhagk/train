			...
			: T extends ArrayType
				...
				: T extends TupleType
					...
					: T extends NamedTupleType
						...
						: T extends RangeType
							? RangeType<scalarAssignableBy<T['__element__']> extends ScalarType ? scalarAssignableBy<T['__element__']> : never>
							: T extends MultiRangeType
								? MultiRangeType<
										scalarAssignableBy<T['__element__']> extends ScalarType ? scalarAssignableBy<T['__element__']> : never
									>
								: never;
export type pointerToAssignmentExpression<Pointer extends PropertyDesc | LinkDesc, IsSetModifier extends boolean = false> = setToAssignmentExpression<
...
export type setToAssignmentExpression<Set extends TypeSet, IsSetModifier extends boolean> = [Set] extends [PrimitiveTypeSet]
	?
			| TypeSet<assignableBy<Set['__element__']>, cardutil.assignable<cardutil.overrideLowerBound<Set['__cardinality__'], 'Zero'>>>
			| getAssignmentLiteral<Set, IsSetModifier>
	: [Set] extends [ObjectTypeSet]
		? TypeSet<
				ObjectType<string, Set['__element__']['__pointers__']>,
				cardutil.assignable<cardutil.overrideLowerBound<Set['__cardinality__'], 'Zero'>>
			>
		: never;
type getAssignmentLiteral<Set extends PrimitiveTypeSet, IsSetModifier extends boolean> =
...
export type pointerToCastableExpression<Pointer extends PropertyDesc | LinkDesc> = [Pointer] extends [PropertyDesc]
	...
	: [Pointer] extends [LinkDesc]
		? TypeSet<ObjectType<string, Pointer['target']['__pointers__']>, cardutil.assignable<Pointer['cardinality']>>
		: never;
export {};
