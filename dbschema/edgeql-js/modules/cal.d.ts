...
> = $.$expr_Function<$local_datetime, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<P2>>>;
...
> = $.$expr_Function<$local_datetime, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
...
declare function to_local_datetime<
	...
	P5 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
	P6 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>
>(year: P1, month: P2, day: P3, hour: P4, min: P5, sec: P6): to_local_datetimeλFuncExpr3<P1, P2, P3, P4, P5, P6>;

declare type to_local_dateλFuncExpr<
	P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>> | undefined
> = $.$expr_Function<$local_date, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<P2>>>;
declare type to_local_dateλFuncExpr2<
	P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>
> = $.$expr_Function<$local_date, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
...
declare type to_local_timeλFuncExpr<
	P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>> | undefined
> = $.$expr_Function<$local_time, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<P2>>>;
declare type to_local_timeλFuncExpr2<
	P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$datetime>>,
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>
> = $.$expr_Function<$local_time, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
...
declare type time_getλFuncExpr<
	...
	P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>
> = $.$expr_Function<_std.$number, $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>>;
/**
 * Extract a specific element of input time by name.
 */
declare function time_get<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$local_time>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>>(
	dt: P1,
	el: P2
 ...
 */
declare function date_get<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$local_date>>, P2 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$str>>>(
	dt: P1,
	el: P2
): date_getλFuncExpr<P1, P2>;

declare type duration_normalize_hoursλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>> = $.$expr_Function<
	$relative_duration,
 ...
 */
declare function duration_normalize_hours<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>>(
	dur: P1
): duration_normalize_hoursλFuncExpr<P1>;

declare type duration_normalize_daysλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$date_duration>>> = $.$expr_Function<
	$date_duration,
	$.cardutil.paramCardinality<P1>
>;
declare type duration_normalize_daysλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>> = $.$expr_Function<
	$relative_duration,
	$.cardutil.paramCardinality<P1>
>;
/**
 ...
 */
declare function duration_normalize_days<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$date_duration>>>(
	dur: P1
): duration_normalize_daysλFuncExpr<P1>;
/**
 * Convert 30-day chunks into months.
 */
declare function duration_normalize_days<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>>(
	dur: P1
