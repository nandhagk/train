...
declare type floorλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bigint>>> = $.$expr_Function<
	_std.$bigint,
	$.cardutil.paramCardinality<P1>
>;
declare type floorλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>> = $.$expr_Function<
	_std.$number,
	$.cardutil.paramCardinality<P1>
>;
declare type floorλFuncExpr3<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.cardutil.paramCardinality<P1>
>;
/**
...
declare type ceilλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bigint>>> = $.$expr_Function<
	_std.$bigint,
	$.cardutil.paramCardinality<P1>
>;
declare type ceilλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>> = $.$expr_Function<
	_std.$number,
	$.cardutil.paramCardinality<P1>
>;
declare type ceilλFuncExpr3<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.cardutil.paramCardinality<P1>
>;
/**
 ...
 */
declare function ceil<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$bigint>>>(x: P1): ceilλFuncExpr<P1>;
/**
 * Round up to the nearest integer.
 */
declare function ceil<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>>(x: P1): ceilλFuncExpr2<P1>;
/**
 * Round up to the nearest integer.
 */
declare function ceil<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>>(x: P1): ceilλFuncExpr3<P1>;

declare type absλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$anyreal>>> = $.$expr_Function<
	_std.$anyreal,
	$.cardutil.paramCardinality<P1>
>;
/**
...
declare type lnλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>> = $.$expr_Function<
	_std.$number,
	$.cardutil.paramCardinality<P1>
>;
declare type lnλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.cardutil.paramCardinality<P1>
>;
/**
...
declare type lgλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>> = $.$expr_Function<
	_std.$number,
	$.cardutil.paramCardinality<P1>
>;
declare type lgλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.cardutil.paramCardinality<P1>
>;
/**
...
declare type sqrtλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>> = $.$expr_Function<
	_std.$number,
	$.cardutil.paramCardinality<P1>
>;
declare type sqrtλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.cardutil.paramCardinality<P1>
>;
/**
 ...
 */
declare function sqrt<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>>(x: P1): sqrtλFuncExpr<P1>;
/**
 * Return the square root of the input value.
 */
declare function sqrt<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>>(x: P1): sqrtλFuncExpr2<P1>;
...
declare type meanλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.Cardinality.One
>;
/**
...
declare type stddevλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.Cardinality.One
>;
/**
...
declare type stddev_popλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.Cardinality.One
>;
/**
...
declare type var_0e9a1bf8ab9d5dc6830438e6ef6633feλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>> = $.$expr_Function<
	_std.$number,
	$.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>
>;
declare type var_0e9a1bf8ab9d5dc6830438e6ef6633feλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> =
	$.$expr_Function<_std.$decimal, $.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>>;
/**
 * Return the sample variance of the input set.
 */
declare function var_0e9a1bf8ab9d5dc6830438e6ef6633fe<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>>(
	vals: P1
): var_0e9a1bf8ab9d5dc6830438e6ef6633feλFuncExpr<P1>;
/**
 * Return the sample variance of the input set.
 */
declare function var_0e9a1bf8ab9d5dc6830438e6ef6633fe<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>>(
	vals: P1
): var_0e9a1bf8ab9d5dc6830438e6ef6633feλFuncExpr2<P1>;

declare type var_popλFuncExpr<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>> = $.$expr_Function<
	_std.$number,
	$.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>
>;
declare type var_popλFuncExpr2<P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>> = $.$expr_Function<
	_std.$decimal,
	$.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>
>;
/**
