...
declare type $SystemObject = $.ObjectType<
	'sys::SystemObject',
	$SystemObjectλShape,
	null,
...
declare type $ExternalObject = $.ObjectType<'sys::ExternalObject', $ExternalObjectλShape, null, [...$SystemObject['__exclusives__']]>;
...
export declare type $DatabaseλShape = $.typeutil.flatten<
	$ExternalObjectλShape &
		_schema.$AnnotationSubjectλShape & {
			name: $.PropertyDesc<_std.$str, $.Cardinality.One, true, false, false, false>;
		}
>;
declare type $Database = $.ObjectType<
	'sys::Database',
	$DatabaseλShape,
	null,
	[
...
export declare type $ExtensionPackageλShape = $.typeutil.flatten<
	$SystemObjectλShape &
		_schema.$AnnotationSubjectλShape & {
...
>;
declare type $ExtensionPackage = $.ObjectType<
...
export declare type $RoleλShape = $.typeutil.flatten<
	$SystemObjectλShape &
...
declare type get_current_branchλFuncExpr = $.$expr_Function<_std.$str, $.Cardinality.One>;
/**
 * Return the name of the current database branch as a string.
 */
declare function get_current_branch(): get_current_branchλFuncExpr;
