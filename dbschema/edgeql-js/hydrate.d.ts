...
export type mergeObjectTypes<A extends ObjectType | undefined, B extends ObjectType | undefined> = A extends ObjectType
	? B extends ObjectType
		? ObjectType<`${A['__name__']} UNION ${B['__name__']}`, mergeObjectShapes<A['__pointers__'], B['__pointers__']>, null>
		: A
	: B extends ObjectType
		? B
		: undefined;
