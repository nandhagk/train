...
declare function range<T extends number | Date | LocalDate | LocalDateTime | Duration>(
	val: Range<T>
...
declare function range<
	...
	P2 extends
		| orScalarLiteral<TypeSet<BaseType extends literalToScalarType<P1> ? $anypoint : getPrimitiveBaseType<literalToScalarType<P1>>>>
		| undefined
>(
	namedArgs: NamedArgs,
	lower?: P1,
	...
	cardutil.multiplyCardinalities<
		cardutil.multiplyCardinalities<
			cardutil.multiplyCardinalities<
				cardutil.multiplyCardinalities<cardutil.optionalParamCardinality<P1>, cardutil.optionalParamCardinality<P2>>,
