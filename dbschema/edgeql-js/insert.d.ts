...
export type RawInsertShape<El extends ObjectType> = ObjectType extends El
	? never
	: typeutil.stripNever<stripNonInsertables<stripBacklinks<El['__pointers__']>>> extends infer Shape
...
export declare function $normaliseInsertShape(
	root: ObjectTypeSet,
	shape: {
		[key: string]: any;
	},
