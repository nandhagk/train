...
(function (cardutil) {
	...
	function mergeCardinalities(a, b) {
		if (a === Cardinality.Empty) return b;
		if (b === Cardinality.Empty) return a;
		if (a === Cardinality.AtLeastOne) return Cardinality.AtLeastOne;
		if (b === Cardinality.AtLeastOne) return Cardinality.AtLeastOne;
		if (a === Cardinality.One) return Cardinality.AtLeastOne;
		if (b === Cardinality.One) return Cardinality.AtLeastOne;
		return Cardinality.Many;
	}
