...
declare function _for<IteratorSet extends BaseTypeSet, Expr extends BaseTypeSet>(
	set: IteratorSet,
	expr: (variable: $expr_ForVar<IteratorSet['__element__']>) => Expr
): $expr_For<Expr['__element__'], cardutil.multiplyCardinalities<IteratorSet['__cardinality__'], Expr['__cardinality__']>>;
export { _for as for };
