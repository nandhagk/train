...
type getChildOfObjectTypeSet<Root extends ObjectTypeSet, ChildKey extends keyof Root['__element__']['__pointers__']> = TypeSet<
	Root['__element__']['__pointers__'][ChildKey]['target'],
	cardutil.multiplyCardinalities<Root['__cardinality__'], Root['__element__']['__pointers__'][ChildKey]['cardinality']>
>;
...
export type $linkPropify<Root extends ObjectTypeSet> = Root extends {
	...
	? Parent['__element__']['__pointers__'][L] extends LinkDesc<any, any, infer LinkProps, any, any, any, any>
		? pathifyLinkProps<LinkProps, Root, PathParent<Parent, L>>
		: {}
	: unknown;
export type $pathify<Root extends TypeSet> = Root extends ObjectTypeSet
	? ObjectTypeSet extends Root
		? unknown
		: pathifyPointers<Root> & pathifyShape<Root> & $linkPropify<Root>
	: unknown;
export type pathifyPointers<Root extends ObjectTypeSet> = ObjectTypePointers extends Root['__element__']['__pointers__']
	? unknown
	: {
			[k in keyof Root['__element__']['__pointers__'] & string]: Root['__element__']['__pointers__'][k] extends PropertyDesc
				? $expr_PathLeaf<
...
export type pathifyShape<
	...
	Shape extends {
		[k: string]: any;
	} = Root['__element__']['__shape__']
> = string extends keyof Shape
	? {}
	: {
			[k in keyof Shape & string]: Shape[k] extends ObjectTypeSet
				? $expr_PathNode<
						TypeSet<Shape[k]['__element__'], cardutil.multiplyCardinalities<Root['__cardinality__'], Shape[k]['__cardinality__']>>,
						{
							type: Root;
							linkName: k;
						}
...
type pathifyLinkProps<Props extends PropertyShape, Root extends ObjectTypeSet, Parent extends PathParent | null = null> = {
	[k in keyof Props & string]: Props[k] extends PropertyDesc
		? $expr_PathLeaf<
				TypeSet<Props[k]['target'], cardutil.multiplyCardinalities<Root['__cardinality__'], Props[k]['cardinality']>>,
				{
...
declare function PathLeaf<Root extends TypeSet, Parent extends PathParent, Exclusive extends boolean = boolean>(
	root: Root,
	parent: Parent,
	exclusive: Exclusive,
	scopeRoot?: TypeSet | null
): $expr_PathLeaf<Root, Parent>;
declare function PathNode<Root extends ObjectTypeSet, Parent extends PathParent | null>(
	root: Root,
	parent: Parent,
	scopeRoot?: TypeSet | null
